...
void dumpInnovTable(sInnovTable innovTable) {
  ...
  for (i = 0; i < innovTable.iNumInnovs; i++) {
    ...
    printf("in=%-2d out=%-2d neuronID=%-2d neuronType=", innovTable.vInnovs[i].iNeuronIn,
           innovTable.vInnovs[i].iNeuronOut, innovTable.vInnovs[i].iNeuronId);
